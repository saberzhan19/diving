            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="http://rahimain/diving/">Главная <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row" id="js-contacts">
                ...
                <?php foreach ($users as $user): ?>
                    ...
                    <div class="col-xl-4">
                        <div id="<? echo $user['id'] ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<? echo $user['data-filter-tags'] ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status <? echo $user['status'];?> mr-3">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="edit.html<? echo $row["id"]?>">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><? echo $user['job'] ?> </span>
                                </div>
